...
public class CreateAccountUseCase {
  ...
  private AccountCreationFailed accountCreationFailedEvent(
      CreateAccountCommand command, String message) {
    return new AccountCreationFailed(
        UUID.randomUUID(), command.userName(), command.email(), message);
  }
