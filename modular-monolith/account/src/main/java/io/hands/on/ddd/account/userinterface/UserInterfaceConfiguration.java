 ...
 */
@Configuration(value = UserInterfaceConfiguration.BeanNames.USER_INTERFACE_CONFIGURATION, proxyBeanMethods = false)
public class UserInterfaceConfiguration {
    ...
    static class BeanNames {
        public static final String USER_INTERFACE_CONFIGURATION = MODULE_PREFIX + "UserInterfaceConfiguration";
        public static final String SUBSCRIPTION_PAID_HANDLER = MODULE_PREFIX + "SubscriptionPaidEventHandler";
    }
}
