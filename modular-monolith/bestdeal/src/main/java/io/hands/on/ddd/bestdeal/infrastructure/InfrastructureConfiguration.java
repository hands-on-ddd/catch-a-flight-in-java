...
import static io.hands.on.ddd.bestdeal.infrastructure.InfrastructureConfiguration.BeanNames.*;
...
public class InfrastructureConfiguration {
  ...
  public static class BeanNames {
    public static final String INFRASTRUCTURE_CONFIGURATION =
    ...
    public static final String ACCOUNT_JDBC_ENTITY_MAPPER =
        MODULE_PREFIX + "AccountJdbcEntityMapper";
  }
}
