...
public class ApplicationConfiguration {
    ...
    public static class BeanNames {
        public static final String APPLICATION_CONFIGURATION = MODULE_PREFIX + "ApplicationConfiguration";
        public static final String INDEX_BESTDEALS_USECASE = MODULE_PREFIX + "IndexBestDealsUseCase";
        public static final String INDEX_FLIGHT_QUERY_USECASE = MODULE_PREFIX + "IndexFlightQueryUseCase";
    }
}
